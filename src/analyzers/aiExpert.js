...
-   **頁面健康度評分**: (0-100分)
-   **關鍵技術發現**: 列出 Top 3 影響該類型頁面目標(排名/轉化)的阻礙,使用項目符號 (bullet points),格式如下:
    * 第一個關鍵發現
    * 第二個關鍵發現
    * 第三個關鍵發現
...
-   **關鍵阻礙 (Top Friction Points)**: 列出阻礙轉化或任務完成的前三大殺手,使用項目符號 (bullet points),格式如下:
    * 第一個阻礙點
    * 第二個阻礙點
    * 第三個阻礙點
...
*   **關鍵戰略發現 (Top 3 Systemic Issues)**: 列出影響全站的結構性問題，使用項目符號 (bullet points)，格式如下:
    *   第一個系統性問題
    *   第二個系統性問題
    *   第三個系統性問題
...
* **關鍵系統性問題 (Top 3 Systemic Issues)**: 列出影響全站的架構性缺陷,使用項目符號 (bullet points),格式如下:
    * 第一個系統性問題
    * 第二個系統性問題
    * 第三個系統性問題
...
* **核心增長瓶頸 (The "Leaky Bucket")**: 列出全站流失最嚴重的環節,使用項目符號 (bullet points),格式如下:
    * 第一個流失環節
    * 第二個流失環節
    * 第三個流失環節
